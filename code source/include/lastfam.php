<?php
$key_api="c4edff79cd9b77ee055fde92512f11e1";
//get artist photo
function getArtistPhoto($artist, $size) {

                $artist = urlencode($artist);
                $xml    = "http://ws.audioscrobbler.com/2.0/?method=artist.getinfo&artist={$artist}&api_key=$key_api";
...
function getArtistAlbums($artist, $size) {
                ...
                $artist = urlencode($artist);
                $xml    = "http://ws.audioscrobbler.com/2.0/?method=artist.gettopalbums&artist={$artist}&api_key=$key_api";
                $xml    = @file_get_contents($xml);
...
function getAlbum($artist, $album, $size) {
                ...
                $xml    = "http://ws.audioscrobbler.com/2.0/?method=album.getinfo&artist={$artist}&album={$album}&api_key=$key_api";
                $xml    = @file_get_contents($xml);
